...
class Router {
    constructor() {
        this.routes = ['home', 'infissi', 'imbiancatura', 'bagno', 'chisiamo', 'contatti'];
        this.init();
    }
    ...
    updateMetaTags(pageId) {
        const pageTitles = {
            ...
            infissi: 'Infissi e Finestre - Nome azienda',
            imbiancatura: 'Imbiancatura Professionale - Nome azienda',
            bagno: 'Rifacimento Bagno - Nome azienda',
            chisiamo: 'Chi Siamo - Nome azienda',
            contatti: 'Contatti - Nome azienda'
        };

        const pageDescriptions = {
            home: 'Esperti in ristrutturazioni civili, infissi, imbiancatura e rifacimento bagni.',
            infissi: 'Installazione di infissi e finestre moderne per la tua casa.',
            imbiancatura: 'Servizi professionali di tinteggiatura e imbiancatura.',
            bagno: 'Ristrutturazione completa del bagno con design moderno.',
